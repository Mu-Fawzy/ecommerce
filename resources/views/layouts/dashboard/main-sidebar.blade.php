			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							{{-- @if (auth()->hasPermission('read_users'))
								<li><a class="slide-item" href="{{ route('users.index') }}">@lang('site.all users')<span class="badge badge-success side-badge">1</span></a></li>
							@endif --}}
