<!-- Sidebar-right-->
		...
		<div class="sidebar sidebar-{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'left' : 'right' }} sidebar-animate">
			<div class="panel panel-primary card mb-0 box-shadow">
				<div class="tab-menu-heading border-0 p-3">
					<div class="card-title mb-0">Notifications</div>
					<div class="card-options m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'r' : 'l' }}-auto">
				...
				<div class="panel-body tabs-menu-body latest-tasks p-0 border-0">
					<div class="tabs-menu ">
						...
						<ul class="nav panel-tabs">
							<li class=""><a href="#side1" class="active" data-toggle="tab"><i class="ion ion-md-chatboxes tx-18 m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-2"></i> Chat</a></li>
							<li><a href="#side2" data-toggle="tab"><i class="ion ion-md-notifications tx-18  m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-2"></i> Notifications</a></li>
							<li><a href="#side3" data-toggle="tab"><i class="ion ion-md-contacts tx-18 m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-2"></i> Friends</a></li>
						</ul>
					</div>
					<div class="tab-content">
						<div class="tab-pane active " id="side1">
							<div class="list d-flex align-items-center border-bottom p-3">
								...
								<a class="wrapper w-100 m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'r' : 'l' }}-3" href="#" >
									<p class="mb-0 d-flex ">
										<b>New Websites is Created</b>
									</p>
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-1"></i>
											<small class="text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-auto">30 mins ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="list d-flex align-items-center border-bottom p-3">
								...
								<a class="wrapper w-100 m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'r' : 'l' }}-3" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-1"></i>
											<small class="text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-auto">2 hours ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="list d-flex align-items-center border-bottom p-3">
								...
								<a class="wrapper w-100 m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'r' : 'l' }}-3" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-1"></i>
											<small class="text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-auto">3 hours ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="list d-flex align-items-center border-bottom p-3">
								...
								<a class="wrapper w-100 m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'r' : 'l' }}-3" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-1"></i>
											<small class="text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-auto">4 hours ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="list d-flex align-items-center border-bottom p-3">
								...
								<a class="wrapper w-100 m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'r' : 'l' }}-3" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-1"></i>
											<small class="text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-auto">1 days ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="list d-flex align-items-center border-bottom p-3">
								...
								<a class="wrapper w-100 m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'r' : 'l' }}-3" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-1"></i>
											<small class="text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-auto">45 mintues ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
							...
							<div class="list d-flex align-items-center p-3">
								...
								<a class="wrapper w-100 m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'r' : 'l' }}-3" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<i class="mdi mdi-clock text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-1"></i>
											<small class="text-muted m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-auto">2 days ago</small>
											<p class="mb-0"></p>
										</div>
									</div>
								</a>
						...
						<div class="tab-pane  " id="side2">
							<div class="list-group list-group-flush ">
								<div class="list-group-item d-flex  align-items-center">
									<div class="m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-3">
						...
						<div class="tab-pane  " id="side3">
							<div class="list-group list-group-flush ">
								<div class="list-group-item d-flex  align-items-center">
									<div class="m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'l' : 'r' }}-2">
									...
									<div class="m{{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'r' : 'l' }}-auto">
